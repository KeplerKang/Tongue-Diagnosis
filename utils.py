...
def files_mask2rle(path):
    ...
    csv = open(r'test_dataset_A/predict.csv', 'w', encoding='utf-8')
...
if __name__ == '__main__':
    # files_rle2mask(r'train_dataset/mask.csv', 'train_dataset/label/')
    files_mask2rle('test_dataset_A/test_label')
